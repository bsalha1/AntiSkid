...
public class PlotSquared4Hook implements PlotSquaredHook
{
    public boolean isAdded(Player player, Location location)
    {
        Plot plot = Plot.getPlot(new com.github.intellectualsites.plotsquared.plot.object.Location(
    ...
    public HashSet<Chunk> getChunks(Location location)
    {
        ...
        List<com.github.intellectualsites.plotsquared.plot.object.Location> corners = plot.getAllCorners();
